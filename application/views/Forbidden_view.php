                    ...
                    <div class="nav-search" id="nav-search">
						<div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-yellow pull-right">
                                ...
                                <li>
                                    <a href="<?=base_url();?>index.php/Forbidden/chanege_language/<?=$language->fld_language_id;?>" ><?=$language->fld_language;?></a>
                                </li>
                                <?php } ?>
							...
							<div class="error-container">
								<div class="well">
									...
									<h3 class="lighter smaller">
										This page is forbidden. becouse Day Open process not finished yet.
