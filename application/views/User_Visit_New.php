                ...
                <div class="span6" style="text-align: left;"> 
                     ...
                     <div class="row-fluid">
                            ...
                            <div class="control-group" style="text-align: center;">
                                <label class="control-label" for="polling_booth">
                                Polling Booth <span class="red">*</span>:
                                </label>
                                <div class="controls">
                                    <select  class="chzn-select" id="polling_booth" name="polling_booth" 
                                    data-placeholder="">
                                        <option value="" />                                        
                                        <?php foreach($booth_list as $ds){ ?>
                                        <option value="<?=$ds->booth_id; ?>" />
                                        <?=$ds->polling_booth_name;  } ?>
                                    </select>
                     ...
                     <div class="row-fluid">
                            ...
                            <div class="control-group" style="text-align: center;">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text"  id="house_no" name="house_no" placeholder="House No " value="<?=set_value('house_no'); ?>">
                     ...
                     <div class="row-fluid">
                        <div class="control-group" style="text-align: center;">
                            ...
                            <div class="controls">
                            <input type="text"  id="total_votes" name="total_votes" placeholder="Total votes " value="<?=set_value('total_votes'); ?>">
                            </div> 
                        </div>
                     </div>
     ...
     <script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>
        ...
        <script>
            ...
            function sumbit_visit_form(){
                    ...
                    var total_votes         = $('#total_votes').val();  
    

                    //add data through ajax//
                       $.ajax({
                            type: 'POST',
                            url:'<?=base_url();?>index.php/User_Visit_Ctrl/sumbit_visit_form_new',
                            dataType: 'json',
                            data:{
                            'house_no':house_no,
            ...
            function clear_form(){
                    ...
                    $('#confirm_votes').val('');  
                    $('#total_votes').val('');  
                     $('#polling_booth').children('option').first().prop('selected', true).trigger("liszt:updated");
